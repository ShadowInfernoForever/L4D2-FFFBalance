...
public OnPluginStart()
{
	...
	hPenaltyIncreaseHunterCvar = CreateConVar("l4d2_m2_hunter_penalty", "4", "How much penalty gets added when you shove a Hunter");
	hPenaltyIncreaseJockeyCvar = CreateConVar("l4d2_m2_jockey_penalty", "4", "How much penalty gets added when you shove a Jockey");
	hPenaltyIncreaseSmokerCvar = CreateConVar("l4d2_m2_smoker_penalty", "3", "How much penalty gets added when you shove a Smoker");
}
