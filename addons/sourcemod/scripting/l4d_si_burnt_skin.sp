...
public int MenuHandleSetBurnPercent(Menu menu, MenuAction action, int param1, int param2)
{
    switch (action)
    {
...
public int MenuHandleBurnPercentClient(Menu menu, MenuAction action, int param1, int param2)
{
    switch (action)
    {
        case MenuAction_Select:
