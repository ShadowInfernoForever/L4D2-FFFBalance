...
{
	show_smoker = CreateConVar("l4d2_show_smoker", "0", "[1 = Enable][0 = Disable] Show Instuctor Hint For Smoker");
	show_boomer = CreateConVar("l4d2_show_boomer", "0", "[1 = Enable][0 = Disable] Show Instuctor Hint For Boomer");
	show_hunter = CreateConVar("l4d2_show_hunter", "0", "[1 = Enable][0 = Disable] Show Instuctor Hint For Hunter");
	show_spitter = CreateConVar("l4d2_show_spitter", "0", "[1 = Enable][0 = Disable] Show Instuctor Hint For Spitter");
	show_jockey = CreateConVar("l4d2_show_jockey", "0", "[1 = Enable][0 = Disable] Show Instuctor Hint For Jockey");
	show_charger = CreateConVar("l4d2_show_charger", "0", "[1 = Enable][0 = Disable] Show Instuctor Hint For Charger");
	show_tank = CreateConVar("l4d2_show_tank", "1", "[1 = Enable][0 = Disable] Show Instuctor Hint For Tank");
	show_witch = CreateConVar("l4d2_show_witch", "0", "[1 = Enable][0 = Disable] Show Instuctor Hint For Witch");
...
{
	if(!IsValidEntRef(HintIndex[target]))
	{
