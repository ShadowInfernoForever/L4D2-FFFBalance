...
public OnPluginStart()
{
	...
	smgSilencedClip = CreateConVar("l4d2_smg_silenced_clip", "55", "Max clip size", DEFAULT_FLAGS);
	smgMp5Clip = CreateConVar("l4d2_smg_mp5_clip", "40", "Max clip size", DEFAULT_FLAGS);
	pumpClip = CreateConVar("l4d2_pump_shotie_clip", "15", "Max clip size", DEFAULT_FLAGS);
	chromeClip = CreateConVar("l4d2_chrome_clip", "15", "Max clip size", DEFAULT_FLAGS);
	huntClip = CreateConVar("l4d2_hunting_clip", "50", "Max clip size", DEFAULT_FLAGS);
	rifleClip = CreateConVar("l4d2_rifle_clip", "50", "Max clip size", DEFAULT_FLAGS);
	rifleAk47Clip = CreateConVar("l4d2_ak47_clip", "30", "Max clip size", DEFAULT_FLAGS);
	rifleDesertClip = CreateConVar("l4d2_desert_clip", "50", "Max clip size", DEFAULT_FLAGS);
	rifleSg552Clip = CreateConVar("l4d2_sg552_clip", "50", "Max clip size", DEFAULT_FLAGS);
	militaryClip = CreateConVar("l4d2_military_clip", "40", "Max clip size", DEFAULT_FLAGS);
	awpClip = CreateConVar("l4d2_awp_clip", "10", "Max clip size", DEFAULT_FLAGS);
	scoutClip = CreateConVar("l4d2_scout_clip", "20", "Max clip size", DEFAULT_FLAGS);
	granedeClip = CreateConVar("l4d2_granede_clip", "5", "Max clip size", DEFAULT_FLAGS);
	m60Clip = CreateConVar("l4d2_m60_clip", "150", "Max clip size", DEFAULT_FLAGS);
	autoClip = CreateConVar("l4d2_autoshot_clip", "15", "Max clip size", DEFAULT_FLAGS);
	spasClip = CreateConVar("l4d2_spas_clip", "17", "Max clip size", DEFAULT_FLAGS);
	pistolClip = CreateConVar("l4d2_pistol_clip", "15", "Max clip size", DEFAULT_FLAGS);
	magnumClip = CreateConVar("l4d2_magnum_clip", "18", "Max clip size", DEFAULT_FLAGS);
...
public Action:Timer_InsertClip(Handle:timer, any:client)
{
	if(client && IsClientConnected(client) && IsClientInGame(client)){
		...
		if(ActiveWeapon != -1){
			...
			{
				if(TimerPlayerReload[client] != INVALID_HANDLE){
					KillTimer(TimerPlayerReload[client]);
					TimerPlayerReload[client] = INVALID_HANDLE;
				}
