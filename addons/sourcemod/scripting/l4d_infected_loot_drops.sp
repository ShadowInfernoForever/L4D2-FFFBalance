...
public OnPluginStart()
{
	...
	CVarHunterLoot[LOOT_DIENUMBER] = CreateConVar("l4d_loot_hunter_dienumber", "2", "Which die (1, 2, 4, or 4) is used when rolling for the hunter", FCVAR_PLUGIN, true, 1.0, true, 4.0);
	...
	CVarHunterLoot[LOOT_ITEM_COUNT] = CreateConVar("l4d_loot_hunter_item_count", "1", "How many items are rolled for when the hunter dies.", FCVAR_PLUGIN, true, 0.0);	
	...
	CVarHunterLoot[LOOT_PILLS_MIN] = CreateConVar("l4d_loot_hunter_pills_min", "0", "Min die number for a hunter to drop pills.", FCVAR_PLUGIN, true, 0.0);
	CVarHunterLoot[LOOT_PILLS_MAX] = CreateConVar("l4d_loot_hunter_pills_max", "0", "Max die number for a hunter to drop pills.", FCVAR_PLUGIN, true, 0.0);
	CVarHunterLoot[LOOT_MOLLY_MIN] = CreateConVar("l4d_loot_hunter_molly_min", "4", "Min die number for a hunter to drop a molitov.", FCVAR_PLUGIN, true, 0.0);
	CVarHunterLoot[LOOT_MOLLY_MAX] = CreateConVar("l4d_loot_hunter_molly_max", "6", "Max die number for a hunter to drop a molitov.", FCVAR_PLUGIN, true, 0.0);
	CVarHunterLoot[LOOT_PIPE_MIN] = CreateConVar("l4d_loot_hunter_pipe_min", "7", "Min die number for a hunter to drop a pipe bomb.", FCVAR_PLUGIN, true, 0.0);
	CVarHunterLoot[LOOT_PIPE_MAX] = CreateConVar("l4d_loot_hunter_pipe_max", "10", "Max die number for a hunter to drop a pipe bomb.", FCVAR_PLUGIN, true, 0.0);
	...
	CVarHunterLoot[LOOT_WITCH_MIN] = CreateConVar("l4d_loot_hunter_witchspawn_min", "0", "Min die number for a hunter to cause a witch to spawn nearby.", FCVAR_PLUGIN, true, 0.0);
	CVarHunterLoot[LOOT_WITCH_MAX] = CreateConVar("l4d_loot_hunter_witchspawn_max", "0", "Max die number for a hunter to cause a witch to spawn nearby.", FCVAR_PLUGIN, true, 0.0);
	...
	CVarHunterLoot[LOOT_PISTOL_MIN] = CreateConVar("l4d_loot_hunter_pistol_min", "0", 	"Min die number for a hunter to drop a pistol.", FCVAR_PLUGIN, true, 0.0);
	CVarHunterLoot[LOOT_PISTOL_MAX] = CreateConVar("l4d_loot_hunter_pistol_max", "0", 	"Max die number for a hunter to drop a pistol.", FCVAR_PLUGIN, true, 0.0);
	CVarHunterLoot[LOOT_SMG_MIN] = CreateConVar("l4d_loot_hunter_smg_min", "0", "Min die number for a hunter to drop a small machine gun.", FCVAR_PLUGIN, true, 0.0);
	CVarHunterLoot[LOOT_SMG_MAX] = CreateConVar("l4d_loot_hunter_smg_max", "0", "Max die number for a hunter to drop a small machine gun.", FCVAR_PLUGIN, true, 0.0);
	CVarHunterLoot[LOOT_SHOT_MIN] = CreateConVar("l4d_loot_hunter_shotgun_min", "0", "Min die number for a hunter to drop a shotgun.", FCVAR_PLUGIN, true, 0.0);
	CVarHunterLoot[LOOT_SHOT_MAX] = CreateConVar("l4d_loot_hunter_shotgun_max", "0", "Max die number for a hunter to drop a shotgun.", FCVAR_PLUGIN, true, 0.0);
	CVarHunterLoot[LOOT_RIFLE_MIN] = CreateConVar("l4d_loot_hunter_rifle_min", "0", "Min die number for a hunter to drop an auto rifle.", FCVAR_PLUGIN, true, 0.0);
	CVarHunterLoot[LOOT_RIFLE_MAX] = CreateConVar("l4d_loot_hunter_rifle_max", "0", "Max die number for a hunter to drop an auto rifle.", FCVAR_PLUGIN, true, 0.0);
	CVarHunterLoot[LOOT_AUTOSHOT_MIN] = CreateConVar("l4d_loot_hunter_autoshot_min", "0", "Min die number for a hunter to drop an auto shotgun.", FCVAR_PLUGIN, true, 0.0);
	CVarHunterLoot[LOOT_AUTOSHOT_MAX] = CreateConVar("l4d_loot_hunter_autoshot_max", "0", "Max die number for a hunter to drop an auto shotgun.", FCVAR_PLUGIN, true, 0.0);
	CVarHunterLoot[LOOT_SNIPER_MIN] = CreateConVar("l4d_loot_hunter_sniper_min", "0", "Min die number for a hunter to drop a sniper rifle.", FCVAR_PLUGIN, true, 0.0);
	CVarHunterLoot[LOOT_SNIPER_MAX] = CreateConVar("l4d_loot_hunter_sniper_max", "0", "Max die number for a hunter to drop a sniper rifle.", FCVAR_PLUGIN, true, 0.0);

	
	
	
	CVarSmokerLoot[LOOT_DIENUMBER] = CreateConVar("l4d_loot_smoker_dienumber", "3", "Which die (1, 2, 4, or 4) is used when rolling for the smoker", FCVAR_PLUGIN, true, 1.0, true, 4.0);
	...
	CVarSmokerLoot[LOOT_ITEM_COUNT] = CreateConVar("l4d_loot_smoker_item_count", "1", "How many items are rolled for when the smoker dies.", FCVAR_PLUGIN, true, 0.0);	
	...
	CVarSmokerLoot[LOOT_PILLS_MIN] = CreateConVar("l4d_loot_smoker_pills_min",	"10", "Min die number for a smoker to drop pills.", FCVAR_PLUGIN, true, 0.0);
	CVarSmokerLoot[LOOT_PILLS_MAX] = CreateConVar("l4d_loot_smoker_pills_max",	"14", "Max die number for a smoker to drop pills.", FCVAR_PLUGIN, true, 0.0);
	...
	CVarSmokerLoot[LOOT_MOLLY_MAX] = CreateConVar("l4d_loot_smoker_molly_max",	"4", "Max die number for a smoker to drop a molitov.", FCVAR_PLUGIN, true, 0.0);
	CVarSmokerLoot[LOOT_PIPE_MIN] = CreateConVar("l4d_loot_smoker_pipe_min", "5", "Min die number for a smoker to drop a pipe bomb.", FCVAR_PLUGIN, true, 0.0);
	CVarSmokerLoot[LOOT_PIPE_MAX] = CreateConVar("l4d_loot_smoker_pipe_max", "8", "Max die number for a smoker to drop a pipe bomb.", FCVAR_PLUGIN, true, 0.0);
	...
	CVarSmokerLoot[LOOT_WITCH_MIN] = CreateConVar("l4d_loot_smoker_witchspawn_min", "0", "Min die number for a smoker to cause a witch to spawn nearby.", FCVAR_PLUGIN, true, 0.0);
	CVarSmokerLoot[LOOT_WITCH_MAX] = CreateConVar("l4d_loot_smoker_witchspawn_max", "0", "Max die number for a smoker to cause a witch to spawn nearby.", FCVAR_PLUGIN, true, 0.0);
	...
	CVarSmokerLoot[LOOT_PISTOL_MAX] = CreateConVar("l4d_loot_smoker_pistol_max", "21", 	"Max die number for a smoker to drop a pistol.", FCVAR_PLUGIN, true, 0.0);
	CVarSmokerLoot[LOOT_SMG_MIN] = CreateConVar("l4d_loot_smoker_smg_min", "22", "Min die number for a smoker to drop a small machine gun.", FCVAR_PLUGIN, true, 0.0);
	CVarSmokerLoot[LOOT_SMG_MAX] = CreateConVar("l4d_loot_smoker_smg_max", "23", "Max die number for a smoker to drop a small machine gun.", FCVAR_PLUGIN, true, 0.0);
	CVarSmokerLoot[LOOT_SHOT_MIN] = CreateConVar("l4d_loot_smoker_shotgun_min", "23", "Min die number for a smoker to drop a shotgun.", FCVAR_PLUGIN, true, 0.0);
	CVarSmokerLoot[LOOT_SHOT_MAX] = CreateConVar("l4d_loot_smoker_shotgun_max", "24", "Max die number for a smoker to drop a shotgun.", FCVAR_PLUGIN, true, 0.0);
	CVarSmokerLoot[LOOT_RIFLE_MIN] = CreateConVar("l4d_loot_smoker_rifle_min",	"25", "Min die number for a smoker to drop an auto rifle.", FCVAR_PLUGIN, true, 0.0);
	CVarSmokerLoot[LOOT_RIFLE_MAX] = CreateConVar("l4d_loot_smoker_rifle_max",	"25", "Max die number for a smoker to drop an auto rifle.", FCVAR_PLUGIN, true, 0.0);
	CVarSmokerLoot[LOOT_AUTOSHOT_MIN] = CreateConVar("l4d_loot_smoker_autoshot_min", "26", "Min die number for a smoker to drop an auto shotgun.", FCVAR_PLUGIN, true, 0.0);
	CVarSmokerLoot[LOOT_AUTOSHOT_MAX] = CreateConVar("l4d_loot_smoker_autoshot_max", "26", "Max die number for a smoker to drop an auto shotgun.", FCVAR_PLUGIN, true, 0.0);
	CVarSmokerLoot[LOOT_SNIPER_MIN] = CreateConVar("l4d_loot_smoker_sniper_min", "27", "Min die number for a smoker to drop a sniper rifle.", FCVAR_PLUGIN, true, 0.0);
	CVarSmokerLoot[LOOT_SNIPER_MAX] = CreateConVar("l4d_loot_smoker_sniper_max", "27", "Max die number for a smoker to drop a sniper rifle.", FCVAR_PLUGIN, true, 0.0);
	...
	CVarBoomerLoot[LOOT_ITEM_COUNT] = CreateConVar("l4d_loot_boomer_item_count", "1", "How many items are rolled for when the boomer dies.", FCVAR_PLUGIN, true, 0.0);	
	...
	CVarBoomerLoot[LOOT_PILLS_MIN] = CreateConVar("l4d_loot_boomer_pills_min",	"2", "Min die number for a boomer to drop pills.", FCVAR_PLUGIN, true, 0.0);
	CVarBoomerLoot[LOOT_PILLS_MAX] = CreateConVar("l4d_loot_boomer_pills_max",	"3", "Max die number for a boomer to drop pills.", FCVAR_PLUGIN, true, 0.0);
	CVarBoomerLoot[LOOT_MOLLY_MIN] = CreateConVar("l4d_loot_boomer_molly_min",	"4", "Min die number for a boomer to drop a molitov.", FCVAR_PLUGIN, true, 0.0);
	CVarBoomerLoot[LOOT_MOLLY_MAX] = CreateConVar("l4d_loot_boomer_molly_max",	"6", "Max die number for a boomer to drop a molitov.", FCVAR_PLUGIN, true, 0.0);
	CVarBoomerLoot[LOOT_PIPE_MIN] = CreateConVar("l4d_loot_boomer_pipe_min", "0", "Min die number for a boomer to drop a pipe bomb.", FCVAR_PLUGIN, true, 0.0);
	CVarBoomerLoot[LOOT_PIPE_MAX] = CreateConVar("l4d_loot_boomer_pipe_max", "0", "Max die number for a boomer to drop a pipe bomb.", FCVAR_PLUGIN, true, 0.0);
	...
	CVarBoomerLoot[LOOT_WITCH_MIN] = CreateConVar("l4d_loot_boomer_witchspawn_min", "0", "Min die number for a boomer to cause a witch to spawn nearby.", FCVAR_PLUGIN, true, 0.0);
	CVarBoomerLoot[LOOT_WITCH_MAX] = CreateConVar("l4d_loot_boomer_witchspawn_max", "0", "Max die number for a boomer to cause a witch to spawn nearby.", FCVAR_PLUGIN, true, 0.0);
	...
	CVarBoomerLoot[LOOT_PISTOL_MIN] = CreateConVar("l4d_loot_boomer_pistol_min", "0", 	"Min die number for a boomer to drop a pistol.", FCVAR_PLUGIN, true, 0.0);
	CVarBoomerLoot[LOOT_PISTOL_MAX] = CreateConVar("l4d_loot_boomer_pistol_max", "0", 	"Max die number for a boomer to drop a pistol.", FCVAR_PLUGIN, true, 0.0);
	...
	CVarTankLoot[LOOT_DIENUMBER] = CreateConVar("l4d_loot_tank_dienumber", "2", "Which die (1, 2, 4, or 4) is used when rolling for the tank", FCVAR_PLUGIN, true, 1.0, true, 4.0);
	...
	CVarTankLoot[LOOT_ITEM_COUNT] = CreateConVar("l4d_loot_tank_item_count", "4", "How many items are rolled for when the tank dies.", FCVAR_PLUGIN, true, 0.0);	
	...
	CVarTankLoot[LOOT_KIT_MAX] = CreateConVar("l4d_loot_tank_kit_max", "5", "Max die number for a tank to drop a kit.", FCVAR_PLUGIN, true, 0.0);
	...
	CVarTankLoot[LOOT_MOLLY_MAX] = CreateConVar("l4d_loot_tank_molly_max",	"10", "Max die number for a tank to drop a molitov.", FCVAR_PLUGIN, true, 0.0);
	CVarTankLoot[LOOT_PIPE_MIN] = CreateConVar("l4d_loot_tank_pipe_min", "11", "Min die number for a tank to drop a pipe bomb.", FCVAR_PLUGIN, true, 0.0);
	CVarTankLoot[LOOT_PIPE_MAX] = CreateConVar("l4d_loot_tank_pipe_max", "12", "Max die number for a tank to drop a pipe bomb.", FCVAR_PLUGIN, true, 0.0);
	
	CVarTankLoot[LOOT_PANIC_MIN] = CreateConVar("l4d_loot_tank_panic_min",	"13", "Min die number for a tank to cause a zombie panic event.", FCVAR_PLUGIN, true, 0.0);
	CVarTankLoot[LOOT_PANIC_MAX] = CreateConVar("l4d_loot_tank_panic_max",	"14", "Max die number for a tank to cause a zombie panic event.", FCVAR_PLUGIN, true, 0.0);
	...
	CVarTankLoot[LOOT_WITCH_MIN] = CreateConVar("l4d_loot_tank_witchspawn_min", "0", "Min die number for a tank to cause a witch to spawn nearby.", FCVAR_PLUGIN, true, 0.0);
	CVarTankLoot[LOOT_WITCH_MAX] = CreateConVar("l4d_loot_tank_witchspawn_max", "0", "Max die number for a tank to cause a witch to spawn nearby.", FCVAR_PLUGIN, true, 0.0);
	...
	CVarTankLoot[LOOT_PISTOL_MIN] = CreateConVar("l4d_loot_tank_pistol_min", "0", 	"Min die number for a tank to drop a pistol.", FCVAR_PLUGIN, true, 0.0);
	CVarTankLoot[LOOT_PISTOL_MAX] = CreateConVar("l4d_loot_tank_pistol_max", "0", 	"Max die number for a tank to drop a pistol.", FCVAR_PLUGIN, true, 0.0);
	CVarTankLoot[LOOT_SMG_MIN] = CreateConVar("l4d_loot_tank_smg_min", "0", "Min die number for a tank to drop a small machine gun.", FCVAR_PLUGIN, true, 0.0);
	CVarTankLoot[LOOT_SMG_MAX] = CreateConVar("l4d_loot_tank_smg_max", "0", "Max die number for a tank to drop a small machine gun.", FCVAR_PLUGIN, true, 0.0);
	CVarTankLoot[LOOT_SHOT_MIN] = CreateConVar("l4d_loot_tank_shotgun_min", "0", "Min die number for a tank to drop a shotgun.", FCVAR_PLUGIN, true, 0.0);
	CVarTankLoot[LOOT_SHOT_MAX] = CreateConVar("l4d_loot_tank_shotgun_max", "0", "Max die number for a tank to drop a shotgun.", FCVAR_PLUGIN, true, 0.0);
	CVarTankLoot[LOOT_RIFLE_MIN] = CreateConVar("l4d_loot_tank_rifle_min",	"15", "Min die number for a tank to drop an auto rifle.", FCVAR_PLUGIN, true, 0.0);
	CVarTankLoot[LOOT_RIFLE_MAX] = CreateConVar("l4d_loot_tank_rifle_max",	"16", "Max die number for a tank to drop an auto rifle.", FCVAR_PLUGIN, true, 0.0);
	CVarTankLoot[LOOT_AUTOSHOT_MIN] = CreateConVar("l4d_loot_tank_autoshot_min", "17", "Min die number for a tank to drop an auto shotgun.", FCVAR_PLUGIN, true, 0.0);
	CVarTankLoot[LOOT_AUTOSHOT_MAX] = CreateConVar("l4d_loot_tank_autoshot_max", "18", "Max die number for a tank to drop an auto shotgun.", FCVAR_PLUGIN, true, 0.0);
	CVarTankLoot[LOOT_SNIPER_MIN] = CreateConVar("l4d_loot_tank_sniper_min", "19", "Min die number for a tank to drop a sniper rifle.", FCVAR_PLUGIN, true, 0.0);
	CVarTankLoot[LOOT_SNIPER_MAX] = CreateConVar("l4d_loot_tank_sniper_max", "20", "Max die number for a tank to drop a sniper rifle.", FCVAR_PLUGIN, true, 0.0);	
