...
#define SOUND_HEADSHOTME1 "physics/metal/metal_solid_impact_bullet1.wav"
#define SOUND_HEADSHOTME2 "physics/metal/metal_solid_impact_bullet3.wav"
#define SOUND_HEADSHOTME3 "physics/metal/metal_solid_impact_bullet4.wav"

#define SOUND_HEADSHOTGL1 "physics/glass/glass_impact_bullet2.wav"
#define SOUND_HEADSHOTGL2 "physics/glass/glass_impact_bullet3.wav"
#define SOUND_HEADSHOTGL3 "physics/glass/glass_impact_bullet1.wav"

#define SOUND_HEADSHOTGORE1 "npc/infected/gore/bullets/bullet_impact_01.wav"
#define SOUND_HEADSHOTGORE2 "npc/infected/gore/bullets/bullet_impact_02.wav"
#define SOUND_HEADSHOTGORE3 "npc/infected/gore/bullets/bullet_impact_03.wav"
#define SOUND_HEADSHOTGORE4 "npc/infected/gore/bullets/bullet_impact_04.wav"
#define SOUND_HEADSHOTGORE5 "npc/infected/gore/bullets/bullet_impact_05.wav"
#define SOUND_HEADSHOTGORE6 "npc/infected/gore/bullets/bullet_impact_06.wav"
#define SOUND_HEADSHOTGORE7 "npc/infected/gore/bullets/bullet_impact_07.wav"
#define SOUND_HEADSHOTGORE8 "npc/infected/gore/bullets/bullet_impact_08.wav"
...
public void OnMapStart() {
    // Precache the metal impact sounds
    PrecacheSound(SOUND_HEADSHOTME1);
    PrecacheSound(SOUND_HEADSHOTME2);
    PrecacheSound(SOUND_HEADSHOTME3);

    // Precache the glass impact sounds
    PrecacheSound(SOUND_HEADSHOTGL1);
    PrecacheSound(SOUND_HEADSHOTGL2);
    PrecacheSound(SOUND_HEADSHOTGL3);

    // Precache the gore impact sounds
    PrecacheSound(SOUND_HEADSHOTGORE1);
    PrecacheSound(SOUND_HEADSHOTGORE2);
    PrecacheSound(SOUND_HEADSHOTGORE3);
    PrecacheSound(SOUND_HEADSHOTGORE4);
    PrecacheSound(SOUND_HEADSHOTGORE5);
    PrecacheSound(SOUND_HEADSHOTGORE6);
    PrecacheSound(SOUND_HEADSHOTGORE7);
    PrecacheSound(SOUND_HEADSHOTGORE8);
}
...
public Action:RiotCop_TraceAttack(victim, &attacker, &inflictor, &Float:damage, &damagetype, &ammotype, hitbox, hitgroup)
{
	...
	if (g_iRiotCopHeadShot_HeadEnable > 0 && hitgroup == 1) 
	{
        ...
        // Array of metal impact sounds
        char metalSounds[][256] = {
            SOUND_HEADSHOTME1,
            SOUND_HEADSHOTME2,
            SOUND_HEADSHOTME3
        };
        int numMetalSounds = sizeof(metalSounds) / sizeof(metalSounds[0]);
        int randomMetalIndex = GetRandomInt(0, numMetalSounds - 1);
        char metalSoundFile[256];
        strcopy(metalSoundFile, sizeof(metalSoundFile), metalSounds[randomMetalIndex]);
        EmitAmbientSound(metalSoundFile, positionVector, attacker, SNDLEVEL_RAIDSIREN);

        // Array of glass impact sounds
        char glassSounds[][256] = {
            SOUND_HEADSHOTGL1,
            SOUND_HEADSHOTGL2,
            SOUND_HEADSHOTGL3
        };
        int numGlassSounds = sizeof(glassSounds) / sizeof(glassSounds[0]);
        int randomGlassIndex = GetRandomInt(0, numGlassSounds - 1);
         char glassSoundFile[256];
        strcopy(glassSoundFile, sizeof(glassSoundFile), glassSounds[randomGlassIndex]);
        EmitAmbientSound(glassSoundFile, positionVector, attacker, SNDLEVEL_RAIDSIREN);

        // Array of gore impact sounds
        char goreSounds[][256] = {
            SOUND_HEADSHOTGORE1,
            SOUND_HEADSHOTGORE2,
            SOUND_HEADSHOTGORE3,
        ...
        int numGoreSounds = sizeof(goreSounds) / sizeof(goreSounds[0]);
        int randomGoreIndex = GetRandomInt(0, numGoreSounds - 1);
        char goreSoundFile[256];
        strcopy(goreSoundFile, sizeof(goreSoundFile), goreSounds[randomGoreIndex]);

        EmitAmbientSound(goreSoundFile, positionVector, attacker, SNDLEVEL_RAIDSIREN);
