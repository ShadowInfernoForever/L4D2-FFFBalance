...
public void OnPluginStart()
{
	...
	LoadTranslations("item_hint.phrases");
...
void CreateStringMap()
{
	...
	// Case-sensitive
	g_smModelToName.SetString("models/w_models/weapons/w_eq_medkit.mdl", "Medkit");
    g_smModelToName.SetString("models/w_models/weapons/w_eq_defibrillator.mdl", "Defibrillator");
    g_smModelToName.SetString("models/w_models/weapons/w_eq_painpills.mdl", "PainPills");
    g_smModelToName.SetString("models/w_models/weapons/w_eq_adrenaline.mdl", "Adrenaline");
    g_smModelToName.SetString("models/w_models/weapons/w_eq_bile_flask.mdl", "BileJar");
    g_smModelToName.SetString("models/w_models/weapons/w_eq_molotov.mdl", "Molotov");
    g_smModelToName.SetString("models/w_models/weapons/w_eq_pipebomb.mdl", "PipeBomb");
    g_smModelToName.SetString("models/w_models/weapons/w_laser_sights.mdl", "LaserSightBox");
    g_smModelToName.SetString("models/w_models/weapons/w_eq_incendiary_ammopack.mdl", "IncendiaryAmmoPack");
    g_smModelToName.SetString("models/w_models/weapons/w_eq_explosive_ammopack.mdl", "ExplosiveAmmoPack");
    g_smModelToName.SetString("models/props/terror/ammo_stack.mdl", "AmmoPile");
    g_smModelToName.SetString("models/props_unique/spawn_apartment/coffeeammo.mdl", "AmmoPile");
    g_smModelToName.SetString("models/props/de_prodigy/ammo_can_02.mdl", "AmmoPile");
    g_smModelToName.SetString("models/weapons/melee/w_chainsaw.mdl", "Chainsaw");
    g_smModelToName.SetString("models/w_models/weapons/w_pistol_b.mdl", "Glock26");
    g_smModelToName.SetString("models/w_models/weapons/w_pistol_a.mdl", "P220");
    g_smModelToName.SetString("models/w_models/weapons/w_desert_eagle.mdl", "DesertEagle");
    g_smModelToName.SetString("models/w_models/weapons/w_shotgun.mdl", "ChromeShotgun");
    g_smModelToName.SetString("models/w_models/weapons/w_pumpshotgun_a.mdl", "PumpShotgun");
    ...
    g_smModelToName.SetString("models/w_models/weapons/w_shotgun_spas.mdl", "SPAS12");
    g_smModelToName.SetString("models/w_models/weapons/w_autoshot_m4super.mdl", "AutoShotgun");
    g_smModelToName.SetString("models/w_models/weapons/w_sniper_mini14.mdl", "HuntingRifle");
    g_smModelToName.SetString("models/w_models/weapons/w_sniper_military.mdl", "MilitarySniper");
    g_smModelToName.SetString("models/w_models/weapons/w_sniper_scout.mdl", "ScoutSniper");
    g_smModelToName.SetString("models/w_models/weapons/w_sniper_awp.mdl", "AWP");
    g_smModelToName.SetString("models/w_models/weapons/w_grenade_launcher.mdl", "GrenadeLauncher");
    g_smModelToName.SetString("models/w_models/weapons/w_m60.mdl", "M60");
    g_smModelToName.SetString("models/props_junk/gascan001a.mdl", "GasCan");
    g_smModelToName.SetString("models/props_junk/explosive_box001.mdl", "FireworksCrate");
    g_smModelToName.SetString("models/props_junk/propanecanister001a.mdl", "PropaneTank");
    g_smModelToName.SetString("models/props_equipment/oxygentank01.mdl", "OxygenTank");
    g_smModelToName.SetString("models/props_junk/gnome.mdl", "Gnome");
    g_smModelToName.SetString("models/w_models/weapons/w_cola.mdl", "ColaBottles");
    g_smModelToName.SetString("models/w_models/weapons/50cal.mdl", "50CalMG");
    g_smModelToName.SetString("models/w_models/weapons/w_minigun.mdl", "Minigun");
    g_smModelToName.SetString("models/props/terror/exploding_ammo.mdl", "ExplosiveAmmoBox");
    g_smModelToName.SetString("models/props/terror/incendiary_ammo.mdl", "IncendiaryAmmoBox");
    g_smModelToName.SetString("models/w_models/weapons/w_knife_t.mdl", "Knife");
    g_smModelToName.SetString("models/weapons/melee/w_bat.mdl", "BaseballBat");
    g_smModelToName.SetString("models/weapons/melee/w_cricket_bat.mdl", "CricketBat");
    g_smModelToName.SetString("models/weapons/melee/w_crowbar.mdl", "Crowbar");
    g_smModelToName.SetString("models/weapons/melee/w_electric_guitar.mdl", "ElectricGuitar");
    g_smModelToName.SetString("models/weapons/melee/w_fireaxe.mdl", "FireAxe");
    g_smModelToName.SetString("models/weapons/melee/w_frying_pan.mdl", "FryingPan");
    ...
    g_smModelToName.SetString("models/weapons/melee/w_tonfa.mdl", "Tonfa");
    g_smModelToName.SetString("models/weapons/melee/w_golfclub.mdl", "GolfClub");
