...
void CreateStringMap()
{
	...
	// Case-sensitive
	g_smModelToName.SetString("models/w_models/weapons/w_eq_medkit.mdl", "Botiquin!");
	g_smModelToName.SetString("models/w_models/weapons/w_eq_defibrillator.mdl", "Desfibrilador!");
	g_smModelToName.SetString("models/w_models/weapons/w_eq_painpills.mdl", "Pildoras Analgésicas!");
	g_smModelToName.SetString("models/w_models/weapons/w_eq_adrenaline.mdl", "Adrenalina!");
	g_smModelToName.SetString("models/w_models/weapons/w_eq_bile_flask.mdl", "Frasco de bilis!");
	g_smModelToName.SetString("models/w_models/weapons/w_eq_molotov.mdl", "Cóctel Molotov!");
	g_smModelToName.SetString("models/w_models/weapons/w_eq_pipebomb.mdl", "Bomba casera!");
	g_smModelToName.SetString("models/w_models/weapons/w_laser_sights.mdl", "Miras Laser!");
	g_smModelToName.SetString("models/w_models/weapons/w_eq_incendiary_ammopack.mdl", "Balas Incendiarias!");
	g_smModelToName.SetString("models/w_models/weapons/w_eq_explosive_ammopack.mdl", "Balas Explosivas!");
	g_smModelToName.SetString("models/props/terror/ammo_stack.mdl", "Munición!");
	g_smModelToName.SetString("models/props_unique/spawn_apartment/coffeeammo.mdl", "Munición!");
	g_smModelToName.SetString("models/props/de_prodigy/ammo_can_02.mdl", "Munición!");
	g_smModelToName.SetString("models/weapons/melee/w_chainsaw.mdl", "Motosierra!");
	g_smModelToName.SetString("models/w_models/weapons/w_pistol_b.mdl", "Glock 26!");
	g_smModelToName.SetString("models/w_models/weapons/w_pistol_a.mdl", "SIG Sauer P220!");
	g_smModelToName.SetString("models/w_models/weapons/w_desert_eagle.mdl", "Desert Eagle Mark VII!");
	g_smModelToName.SetString("models/w_models/weapons/w_shotgun.mdl", "Remington 870 Marine Magnum");
	g_smModelToName.SetString("models/w_models/weapons/w_pumpshotgun_a.mdl", "Remington 870 Police Magnum Riot!");
	g_smModelToName.SetString("models/w_models/weapons/w_smg_uzi.mdl", "Imi Uzi!");
	g_smModelToName.SetString("models/w_models/weapons/w_smg_a.mdl", "Mac-10!");
	g_smModelToName.SetString("models/w_models/weapons/w_smg_mp5.mdl", "Heckler & Koch MP5N!");
	g_smModelToName.SetString("models/w_models/weapons/w_rifle_m16a2.mdl", "M16A2!");
	g_smModelToName.SetString("models/w_models/weapons/w_rifle_sg552.mdl", "SIG SG-552 Commando!");
	g_smModelToName.SetString("models/w_models/weapons/w_rifle_ak47.mdl", "AKMN!");
	g_smModelToName.SetString("models/w_models/weapons/w_desert_rifle.mdl", "FN SCAR-L Mk 16!");
	g_smModelToName.SetString("models/w_models/weapons/w_shotgun_spas.mdl", "Franchi SPAS-12!");
	g_smModelToName.SetString("models/w_models/weapons/w_autoshot_m4super.mdl", "Benelli M4 Super 90!");
	g_smModelToName.SetString("models/w_models/weapons/w_sniper_mini14.mdl", "Ruger Mini-14!");
	g_smModelToName.SetString("models/w_models/weapons/w_sniper_military.mdl", "Heckler & Koch G3SG/1!");
	g_smModelToName.SetString("models/w_models/weapons/w_sniper_scout.mdl", "Steyr Arms Scout!");
	g_smModelToName.SetString("models/w_models/weapons/w_sniper_awp.mdl", "AWM!");
	g_smModelToName.SetString("models/w_models/weapons/w_grenade_launcher.mdl", "Lanzagranadas M79!");
	g_smModelToName.SetString("models/w_models/weapons/w_m60.mdl", "M60!");
	g_smModelToName.SetString("models/props_junk/gascan001a.mdl", "Lata de gasolina!");
	g_smModelToName.SetString("models/props_junk/explosive_box001.mdl", "Fuegos Artificiales!");
	g_smModelToName.SetString("models/props_junk/propanecanister001a.mdl", "Tanque de Propano!");
	g_smModelToName.SetString("models/props_equipment/oxygentank01.mdl", "Tanque de Oxigeno!");
	g_smModelToName.SetString("models/props_junk/gnome.mdl", "Gnomo de jardin!");
	g_smModelToName.SetString("models/w_models/weapons/w_cola.mdl", "Coca Cola!");
	g_smModelToName.SetString("models/w_models/weapons/50cal.mdl", "Ametralladora Calibre 50.");
	g_smModelToName.SetString("models/w_models/weapons/w_minigun.mdl", "M61 Vulcan!");
	g_smModelToName.SetString("models/props/terror/exploding_ammo.mdl", "Balas Explosivas!");
	g_smModelToName.SetString("models/props/terror/incendiary_ammo.mdl", "Balas Incendiarias!");
	g_smModelToName.SetString("models/w_models/weapons/w_knife_t.mdl", "Badlands Bowie!");
	g_smModelToName.SetString("models/weapons/melee/w_bat.mdl", "Bate de Beisbol!");
	g_smModelToName.SetString("models/weapons/melee/w_cricket_bat.mdl", "Bate de Cricket!");
	g_smModelToName.SetString("models/weapons/melee/w_crowbar.mdl", "Palanqueta!");
	g_smModelToName.SetString("models/weapons/melee/w_electric_guitar.mdl", "Guitarra Electrica!");
	g_smModelToName.SetString("models/weapons/melee/w_fireaxe.mdl", "Hacha de bombero!");
	g_smModelToName.SetString("models/weapons/melee/w_frying_pan.mdl", "Sarten!");
	...
	g_smModelToName.SetString("models/weapons/melee/w_tonfa.mdl", "Porra de policía!");
	g_smModelToName.SetString("models/weapons/melee/w_golfclub.mdl", "Palo de golf!");
	g_smModelToName.SetString("models/weapons/melee/w_pitchfork.mdl", "Horquilla!");
	g_smModelToName.SetString("models/weapons/melee/w_shovel.mdl", "Pala");
	g_smModelToName.SetString("models/infected/boomette.mdl", "Reventón!");
	g_smModelToName.SetString("models/infected/boomer.mdl", "Reventón!");
	g_smModelToName.SetString("models/infected/boomer_l4d1.mdl", "Reventón!");
	g_smModelToName.SetString("models/infected/hulk.mdl", "Coloso! (Tank)");
	g_smModelToName.SetString("models/infected/hulk_l4d1.mdl", "Coloso! (Tank)");
	g_smModelToName.SetString("models/infected/hulk_dlc3.mdl", "Coloso! (Tank)");
	g_smModelToName.SetString("models/infected/smoker.mdl", "Estrangulador! (Smoker)");
	g_smModelToName.SetString("models/infected/smoker_l4d1.mdl", "Estrangulador! (Smoker)");
	g_smModelToName.SetString("models/infected/hunter.mdl", "Acechador! (Hunter)");
	g_smModelToName.SetString("models/infected/hunter_l4d1.mdl", "Acechador! (Hunter)");
	g_smModelToName.SetString("models/infected/witch.mdl", "Lamentadora! (Witch)");
	g_smModelToName.SetString("models/infected/witch_bride.mdl", "Lamentadora! (Witch)");
	g_smModelToName.SetString("models/infected/spitter.mdl", "Corrosiva! (Spitter)");
	g_smModelToName.SetString("models/infected/jockey.mdl", "Jinete! (Jockey)");
	g_smModelToName.SetString("models/infected/charger.mdl", "Demoledor! (Charger)");
		...
		switch(g_iInfectedMarkAnnounceType)
		{
			...
			case 1: {
				for (int i=1; i <= MaxClients; i++)
				{
					if (IsClientInGame(i) && !IsFakeClient(i) && GetClientTeam(i) != TEAM_INFECTED)
					{
						CPrintToChat(i, "{blue}%N{default}: {default}%s", client, sItemName);
					}
				}
			}
			case 2: {
...
void CreateInstructorHint(int client, const float vOrigin[3], const char[] sItemName, int iEntity, EHintType type)
{
	...
	switch(type)
	{
		...
		case view_as<EHintType>(eSpotMarker):
		{
			...
			{
				FormatEx(sCaption, sizeof sCaption, "Defend Here!", client);
