...
static const char g_kill_type[][] =
{
	...
	"Shotgun",      //4 shotgun
	"Sniper",    //5 sniper
	"PipeBomb",          //6 pipe bomb
	"Burn",      //7 inferno, entityflame
	"M60",	//8 M60
	"GrenadeLauncher",	    //9 grenade_launcher_projectile

	"Push",	     //10 killed by push
	"World",           //11 killed by world
	"'SI'",         //12 killed by special infected,
	"WallBang",           //13 kill behind wall
	"HeadShot",           //14 headshot
};
