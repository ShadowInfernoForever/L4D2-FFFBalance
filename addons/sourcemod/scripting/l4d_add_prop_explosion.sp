...
public Action CmdPrintCvars(int client, int args)
{
    ...
    PrintToConsole(client, "l4d_add_prop_explosion_gascan_chance : %.1f%% (%s)", g_fCvar_GascanChance, g_bCvar_GascanChance ? "true" : "false");
    PrintToConsole(client, "l4d_add_prop_explosion_fuelbarrel : %i (%s)", g_iCvar_FuelBarrel, g_bCvar_FuelBarrel ? "true" : "false");
    PrintToConsole(client, "l4d_add_prop_explosion_fuelbarrel_chance : %.1f%% (%s)", g_fCvar_FuelBarrelChance, g_bCvar_FuelBarrelChance ? "true" : "false");
    ...
    PrintToConsole(client, "l4d_add_prop_explosion_propanecanister_chance : %.1f%% (%s)", g_fCvar_PropaneCanisterChance, g_bCvar_PropaneCanisterChance ? "true" : "false");
    PrintToConsole(client, "l4d_add_prop_explosion_oxygentank : %i (%s)", g_iCvar_OxygenTank, g_bCvar_OxygenTank ? "true" : "false");
    PrintToConsole(client, "l4d_add_prop_explosion_oxygentank_chance : %.1f%% (%s)", g_fCvar_OxygenTankChance, g_bCvar_OxygenTankChance ? "true" : "false");
    ...
    PrintToConsole(client, "l4d_add_prop_explosion_barricadegascan_chance : %.1f%% (%s)", g_fCvar_BarricadeGascanChance, g_bCvar_BarricadeGascanChance ? "true" : "false");
    PrintToConsole(client, "l4d_add_prop_explosion_gaspump : %i (%s)", g_iCvar_GasPump, g_bCvar_GasPump ? "true" : "false");
    PrintToConsole(client, "l4d_add_prop_explosion_gaspump_chance : %.1f%% (%s)", g_fCvar_GasPumpChance, g_bCvar_GasPumpChance ? "true" : "false");
    ...
    PrintToConsole(client, "l4d_add_prop_explosion_oildrumexplosive_chance : %.1f%% (%s)", g_fCvar_OilDrumExplosiveChance, g_bCvar_OilDrumExplosiveChance ? "true" : "false");
    ...
    if (g_bL4D2) PrintToConsole(client, "l4d_add_prop_explosion_fireworkscrate_chance : %.1f%% (%s)", g_fCvar_FireworksCrateChance, g_bCvar_FireworksCrateChance ? "true" : "false");
    PrintToConsole(client, "");
    PrintToConsole(client, "======================================================================");
    PrintToConsole(client, "");
