...
#define Radio1 "insanity/z_horde1.mp3"
#define Radio2 "insanity/z_horde2.mp3"
#define Radio3 "insanity/z_horde3.mp3"
#define Radio4 "insanity/z_horde4.mp3"
#define Radio5 "insanity/z_horde5.mp3"
...
PrecacheSound(Radio1, true);
PrecacheSound(Radio2, true);
PrecacheSound(Radio3, true);
PrecacheSound(Radio4, true);
PrecacheSound(Radio5, true);

AddFileToDownloadsTable("sound/insanity/z_horde1.mp3");
AddFileToDownloadsTable("sound/insanity/z_horde2.mp3");
AddFileToDownloadsTable("sound/insanity/z_horde3.mp3");
AddFileToDownloadsTable("sound/insanity/z_horde4.mp3");
AddFileToDownloadsTable("sound/insanity/z_horde5.mp3");
...
public Action OnTimedHordesContinuing(float &timeHordesPast, float timeHordesCap) {
	...
	if (timeHordesCap - timeHordesPast <= 1) {
	...
	if ( (timeHordesCap - timeHordesPast <= 10) && (timeHordesCap - timeHordesPast >= 10) ) {
	...
	GameRules_SetPropFloat("m_fScriptedHUDPosX",  0.000, 0);
	GameRules_SetPropFloat("m_fScriptedHUDPosY",  0.0149, 0);
	GameRules_SetPropFloat("m_fScriptedHUDWidth", 0.5000, 0);
