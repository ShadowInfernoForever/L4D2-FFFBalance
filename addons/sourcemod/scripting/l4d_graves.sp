...
public void OnPluginStart()
{
	...
	g_hGraveDelay 		= CreateConVar("l4d_graves_delay", "1.0", "How long will it take for the grave to spawn.", FCVAR_NOTIFY, true, 1.0);
	g_hGraveGlow 		= CreateConVar("l4d_graves_glow", "1", "Turn glow On or Off.", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	g_hGraveGlowColor 	= CreateConVar("l4d_graves_glowcolor", "20 20 20", "RGB Color - Change the render color of the glow. Values between 0-255. Note: Only for Left 4 Dead 2.", FCVAR_NOTIFY);
