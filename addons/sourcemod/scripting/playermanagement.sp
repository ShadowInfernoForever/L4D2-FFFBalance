...
public void OnPluginStart()
{
	...
	RegConsoleCmd("sm_afk", Spectate_Cmd, "Moves you to the spectator team");
	RegConsoleCmd("sm_espectador", Spectate_Cmd, "Moves you to the spectator team");
	RegConsoleCmd("sm_jugar", Survivor_Cmd, "Moves you to the survivors team");
	RegConsoleCmd("sm_join", Survivor_Cmd, "Moves you to the survivors team");
	RegConsoleCmd("sm_survivor", Survivor_Cmd, "Moves you to the survivors team");
	RegConsoleCmd("sm_superviviente", Survivor_Cmd, "Moves you to the survivors team");
	RegConsoleCmd("sm_supervivientes", Survivor_Cmd, "Moves you to the survivors team");
	RegConsoleCmd("sm_humano", Survivor_Cmd, "Moves you to the survivors team");
...
Action Survivor_Cmd(int client, int args)
{ 
	ClientCommand(client, "jointeam 2");
	return Plugin_Handled;
}

Action Infected_Cmd(int client, int args)
{ 
