...
static ConVar g_hCvar_DetectModel;
static ConVar g_hCvar_Interval;
static ConVar g_hCvar_SelfieFOV;
...
static bool   g_bCvar_DetectModel;
static bool   g_bCvar_Interval;
static bool   g_bCvar_SelfieFOV;

// ====================================================================================================
// int - Plugin Variables
// ====================================================================================================
static int    g_iCvar_SelfieFOV;
...
static float  g_fCvar_DetectModel;
...
static char   g_sStopInput[32];
static char   g_sFireUser2Input[32];

// ====================================================================================================
// client - Plugin Variables
// ====================================================================================================
static bool   gc_bThirdPerson[MAXPLAYERS+1];
static int    gc_iLastCharacterNumber[MAXPLAYERS+1];
...
public Action TimerDetectModel(Handle timer)
{
    for (int client = 1; client <= MaxClients; client++)
    {
        if (!IsClientInGame(client))
...
public void SetEdictAlways(int edict)
{
...
public int HandleEyesMenu(Menu menu, MenuAction action, int param1, int param2)
{
    switch (action)
    {
...
public int HandleParticleMenu(Menu menu, MenuAction action, int param1, int param2)
{
    switch (action)
    {
        case MenuAction_Select:
