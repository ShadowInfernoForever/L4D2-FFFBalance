...
void DoSpawnCommand(int client, int args, bool projectile)
{
	...
	if( args != 1 )
	{
		ReplyToCommand(client, "Usage: sm_grenade_%s <1=Bomb, 2=Cluster, 3=Firework, 4=Smoke, 5=Black Hole, 6=Flashbang, 7=Shield, 8=Tesla, 9=Chemical, 10=Freeze, 11=Medic, 12=Vaporizer, 13=Extinguisher, 14=Glow, 15=Anti-Gravity, 16=Fire Cluster, 17=Bullets, 18=Flak, 19=Airstrike, 20=Airdrop, 21=Weapon>", projectile ? "throw" : "spawn");
		return;
	}
...
Action Cmd_Grenade(int client, int args)
{
	...
	if( g_bCvarAllow == false || g_iConfigPrefs == 3 || CheckCommandAccess(client, "sm_grenade", 0) == false )
	{
		return Plugin_Handled;
	}
...
void LoadDataConfig()
{
	...
	LoadDataEntry(INDEX_AIRDROP,		hFile,		"Mod_Airdrop");
...
void DoPrjEffects(int entity, int index)
{
	switch( index - 1 )
	{
		...
		case INDEX_AIRDROP:		    PrjEffects_Airstrike		(entity);
...
void Explode_Effects(int client, int entity, int index, bool fromTimer = true)
{
	...
	switch( index - 1 )
	{
		...
		case INDEX_AIRDROP:		    Explode_Airdrop		    (client, entity, index);
...
// ====================================================================================================
//					EXPLOSION FX - AIRDROP
// ====================================================================================================
void Explode_Airdrop(int client, int entity, int index)
{
	...
	//F18_ShowAirstrike(vPos, GetRandomFloat(0.0, 180.0))
	//CreateAirdrop(vPos, GetRandomFloat(0.0, 180.0), .trace_to_sky = true);
}
