...
public OnPluginStart()
{
	...
	g_hDebugMode = CreateConVar("vocalize_debug", "0", "Enables debug mode for vocalize commands", FCVAR_NONE, true, 0.0, true, 1.0);
	
#if USE_VERSION_CONVAR
	CreateConVar(CONVAR_VERSION_NAME, CONVAR_VERSION_VALUE, CONVAR_VERSION_DESC, FCVAR_PLUGIN | FCVAR_NOTIFY)
#endif
}
...
bool IsDebugEnabled()
{
    return g_hDebugMode != null && g_hDebugMode.BoolValue;
}