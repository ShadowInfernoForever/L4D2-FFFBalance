...
// ====================================================================================================
static char   g_sCvar_AliveModel[PLATFORM_MAX_PATH];
static char   g_sCvar_AliveAlpha[4];
static char   g_sCvar_AliveScale[5];
static char   g_sCvar_DeadModel[PLATFORM_MAX_PATH];
...
static char   g_sCvar_CustomModelVMT[PLATFORM_MAX_PATH];
static char   g_sCvar_CustomModelVTF[PLATFORM_MAX_PATH];
...
public void GetCvars()
{
    ...
    FormatEx(g_sCvar_AliveScale, sizeof(g_sCvar_AliveScale), "%.1f", g_fCvar_AliveScale);
    ...
    FormatEx(g_sCvar_DeadScale, sizeof(g_sCvar_DeadScale), "%.1f", g_fCvar_DeadScale);
...
public int HandleToggleMenu(Menu menu, MenuAction action, int param1, int param2)
{
    switch (action)
    {
