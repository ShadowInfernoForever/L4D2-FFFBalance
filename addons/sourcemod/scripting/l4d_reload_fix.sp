...
{
	g_hCvarM60 = CreateConVar("l4d_reload_fix_m60", "0", "0=Off, 1=Fix the M60 from reload bug issues.", FCVAR_NOTIFY);
...
void Event_Reload(Event event, const char[] name, bool dontBroadcast)
{
	...
	)
	{
		...
		{
			CreateTimer(5.0, TimerReload, EntIndexToEntRef(weapon), TIMER_REPEAT);
		}
	}
}
