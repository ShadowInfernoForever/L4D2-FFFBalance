...
public void OnPluginStart()
{
	...
	g_hCvarDelay = CreateConVar(			"sm_votedifficulty_delay",				"60",			"Minimum delay (in sec.) allowed between votes", CVAR_FLAGS );
	...
	g_hCvarLog = CreateConVar(				"sm_votedifficulty_log",				"1",			"Use logging? (1 - Yes / 0 - No)", CVAR_FLAGS );
	...
	g_hCvarUseConfigPerDif = CreateConVar(	"sm_votedifficulty_use_config_per_dif",	"1",			"Use separate configs per each default difficulties ? (1 - Yes / 0 - No)", CVAR_FLAGS );
