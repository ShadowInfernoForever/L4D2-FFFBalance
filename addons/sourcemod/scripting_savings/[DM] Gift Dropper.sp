...
public void OnPluginStart()
{
	...
	*/
	...
	g_hCvarCount = CreateConVar(		"l4d2_gift_rewards_count",			"5",			"0=No restriction. This number of Special Infected must die before allowing the drop chance of spawning a Gift.", CVAR_FLAGS );
	g_hCvarDrop = CreateConVar(			"l4d2_gift_rewards_drop",			"-1.0",			"-1.0=Use games z_holiday_gift_drop_chance cvar value. 0.0=Off. 1.0=Maximum chance. The chance to randomly drop gifts on Special Infected death.", CVAR_FLAGS, true, 0.0, true, 1.0 );
