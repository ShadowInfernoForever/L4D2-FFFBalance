...
public void OnPluginStart()
{
	...
	g_hCvarHealth 			= CreateConVar(	"l4d_hunter_finale_health",			"150",		"Health of finale multi-spawned hunters", CVAR_FLAGS );
	...
	RegAdminCmd("sm_hunterhorde", CmdT, ADMFLAG_ROOT);
...
void ForceInfiniteHunters()
{
	delete g_hTimer;
	delete g_hTimer2;
	g_hTimer = CreateTimer(2.0, Timer_SpawnHunters, _, TIMER_REPEAT);
