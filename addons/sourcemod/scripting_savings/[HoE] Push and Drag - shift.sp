...
#define SOUND_GRAB		"ITEMS/itempickup.wav"
new g_iVelocity ;
		...
		if(ent>0)
		{
			...
			if(dis<120.0)
			{
				...
				{			 
					...
					{
						HoldDistance[client]=30.0;
						GrabEnerge[client]=ctime+2000.0;
					...
					else
					{
						...
						{
							PrintHintText(client, "• Agarraste algo.");
						}
						else
						{
			...
			{
				ent=0;
				PrintHintText(client, "• Está demasiado lejos");
			}
		}
		else
		{
			PrintHintText(client, "• No Agarraste Nada.");
		}
	}
	CloseHandle(trace)
