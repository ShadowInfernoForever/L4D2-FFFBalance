...
## VERSION 11.80 - 29/7/2026

-------------------------------------------------------------------------------

- Reworked `Hardmode`, now using `CompetitiveWithAnne` hardai.
- changed z_spit_latency in Equinix.cfg, `0ms` -> `0.1ms`
- Removed not used stuff in `hardmode.cfg`
- Reduced hardmode spawntimes `20s` -> `16s`
