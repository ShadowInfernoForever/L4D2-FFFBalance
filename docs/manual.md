...
Sin embargo, si desea cambiar el modo de juego o cargar uno de los modos personalizados, puede usar **comandos de chat** o **comandos de consola**.
...
## 📄 Notas
- Todos los comandos son accesibles para los jugadores, a menos que el administrador configure lo contrario.
